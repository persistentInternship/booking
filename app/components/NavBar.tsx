      ...
      <Navbar className="navbar hidden lg:flex" style={{
        ...
        <Navbar.End className="navbar-end">
          ...
          {status === 'authenticated' ? (
            <button onClick={() => signOut()} className="bg-transparent hover:bg-opacity-20 hover:bg-gray-700 text-white font-semibold py-2 px-4 mr-2 focus:outline-none border-0">
              Logout
            </button>
          ) : (
          ...
          <Button color="ghost" shape="circle" onClick={handleSettingsClick}>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
